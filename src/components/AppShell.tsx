...
const navGroups: NavGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { path: "/ai-api-settings", icon: Brain, label: "AI API Settings" },
      ...
      >
        ...
        <div className="p-3 border-t border-border flex-shrink-0">
          ...
          <div className="flex items-center gap-3 px-2 py-2 rounded-expo-lg hover:bg-sidebar-accent transition-colors group">
            <Avatar className="w-8 h-8 bg-primary ring-2 ring-border">
          ...
          <div className="flex-1 max-w-md">
            ...
            >
              ...
              <input
                ...
                className="w-full bg-muted border border-border rounded-lg pl-9 pr-16 py-2 text-sm text-foreground placeholder:text-muted-foreground/40 focus:outline-none focus:border-primary/30 focus:ring-1 focus:ring-primary/20 cursor-pointer transition-all"
              />
